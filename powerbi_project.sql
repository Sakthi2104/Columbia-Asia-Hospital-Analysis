...
#Question 16: Find the department where the average waiting time has decreased over three consecutive months. (SQL)
with cte as
...
#Question 17: Determine the ratio of male to female patients for each doctor and rank the doctors based on this ratio. (SQL)
with cte as 
...
#Question 18: Calculate the average satisfaction score of patients for each doctor based on their visits. (SQL)
select d.`Doctor Name` as Doctor_Name,
...
#Question 19: Find doctors who have treated patients from different races and calculate the diversity of their patient base. (SQL)
select d.`Doctor Name` as Doctor_Name,
...
#Question 20: Calculate the ratio of total bills generated by male patients to female patients for each department. (SQL)
...
#Question 21: Update the patient satisfaction score for all patients who visited the "General Practice" department and had a waiting time of more than 30 minutes. Increase their satisfaction score by 2 points, but ensure that the satisfaction score does not exceed 10. (SQL)
SET SQL_SAFE_UPDATES = 0;

UPDATE hospital_er 
SET patient_sat_score = LEAST(patient_sat_score + 2, 10) 
WHERE LOWER(department_referral) = "general practice" 
